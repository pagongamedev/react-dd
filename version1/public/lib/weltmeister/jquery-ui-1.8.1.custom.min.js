  ...
  d.widget('ui.sortable', d.ui.mouse, {
    ...
    _mouseDrag: function (a) {
      ...
      if (this.options.scroll) {
        ...
        if (this.scrollParent[0] != document && this.scrollParent[0].tagName != 'HTML') {
          if (
            this.overflowOffset.top + this.scrollParent[0].offsetHeight - a.pageY <
            b.scrollSensitivity
          )
            ...
            this.scrollParent[0].scrollTop = c =
              this.scrollParent[0].scrollTop - b.scrollSpeed;
          if (
            this.overflowOffset.left + this.scrollParent[0].offsetWidth - a.pageX <
            b.scrollSensitivity
          )
    ...
    _refreshItems: function (a) {
      ...
      var b = this.items,
        c = [
          [
            d.isFunction(this.options.items)
              ? this.options.items.call(this.element[0], a, { item: this.currentItem })
              : d(this.options.items, this.element),
            this,
          ],
        ],
            ...
            if (i && i != this && !i.options.disabled) {
              c.push([
                d.isFunction(i.options.items)
                  ? i.options.items.call(i.element[0], a, { item: this.currentItem })
    ...
    _contactContainers: function (a) {
      ...
      if (b)
        if (this.containers.length === 1) {
          ...
          e = null;
          for (
            var f = this.positionAbs[this.containers[c].floating ? 'left' : 'top'],
